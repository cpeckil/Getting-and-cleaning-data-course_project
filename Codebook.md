...
The raw data from the experiment was randomly partitioned into two sets, where 70% of the volunteers were selected for generating the training data and 30% the test data.
...
X, Y and Z above represent the axis of the direction of movement.

- The units of the data set are in time and frequency.  They are normalized and bounded within [-1,1].
